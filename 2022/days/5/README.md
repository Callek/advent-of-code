...
but they forgot to ask her **which** crate will end up where, and they want to be
ready to unload them as soon as possible so they can embark.
...
crates; from bottom to top, they are crates `M`, `C`, and `D`. Finally, stack
